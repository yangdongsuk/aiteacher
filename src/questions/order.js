...
// 5. Now I'll format it. You should only say 3 lists "잘못된 부분 :, 힌트 :, 관련된 개념: "
//     5.1. 잘못된 부분  : put what part the student got wrong.
//     5.2. 힌트 : put a hint on how to solve it. Be very detailed and kind, give examples, show some of the correct code.
//     But don't give  the full code. Even if you give the code, just give code max two line.
//     5.3. 관련된 개념 : organize and put concepts related to this.
